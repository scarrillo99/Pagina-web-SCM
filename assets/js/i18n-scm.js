...
window.I18N_DICT = {
  es: {
    ...
    'welcome.p1':
      'Somos SCM Sports Agency, una agencia boutique internacional de representación y gestión integral de futbolistas profesionales, con la Costa del Sol como base y toda Europa como mercado.',
    'welcome.p2':
      'Formamos parte de SCM Group, un family group con más de 40 años de trayectoria en inmobiliaria, inversión y construcción, presente en el deporte desde 2014 a través de Magno Marbella. Trabajamos desde La Quinta, junto al Marbella Football Center, una de las zonas más prestigiosas de la ciudad.',
    ...
    'base.0': 'Asesor privado de carrera',
    'base.1': 'Psicólogo deportivo',
    'base.2': 'Analista de rendimiento',
    'base.3': 'Preparador físico',
    'base.4': 'Nutricionista',
    'base.5': 'Comunicación y marketing',
    'nums.cta': 'Y alrededor de la base, todo lo demás: ver todos los servicios',
    ...
    'why.eyebrow': '¿Por qué SCM?',
    'values.1': 'Soporte individual',
    'values.2': 'Transparencia',
    'values.3': 'Lealtad',
    'values.4': 'Visión',
    'values.5': 'Innovación',
    'values.6': 'Sostenibilidad',
    'why.title': 'El talento <em>no basta</em>',
    'why.p1':
      'En ti no vemos solo al futbolista: vemos también a la persona, la marca y el patrimonio que hay detrás. Con un método semanal y un equipo de especialistas te llevamos al máximo en lo deportivo, en lo personal y en lo económico.',
    'why.p2': 'SCM piensa y actúa por tu futuro mucho más allá de los límites del campo.',
    'why.p3': 'Únete a SCM y conviértete en el protagonista de tu carrera.',
    'why.cta': 'Cartera oficial en Transfermarkt',
  ...
  en: {
    ...
    'welcome.title': 'Welcome to <em>SCM</em>',
    'welcome.p1':
      'We are SCM Sports Agency, an international boutique agency for the representation and complete management of professional footballers, with the Costa del Sol as our base and all of Europe as our market.',
    'welcome.p2':
      'We are part of SCM Group, a family group with over 40 years of track record in real estate, investment and construction, present in sport since 2014 through Magno Marbella. We work from La Quinta, next to the Marbella Football Center, one of the most prestigious areas of the city.',
    ...
    'base.0': 'Private career advisor',
    'base.1': 'Sports psychologist',
    'base.2': 'Performance analyst',
    'base.3': 'Strength and conditioning coach',
    'base.4': 'Nutritionist',
    'base.5': 'Communication and marketing',
    'nums.cta': 'And around the base, everything else: see all services',
    ...
    'why.eyebrow': 'Why SCM?',
    'values.1': 'Individual support',
    'values.2': 'Transparency',
    'values.3': 'Loyalty',
    'values.4': 'Vision',
    'values.5': 'Innovation',
    'values.6': 'Sustainability',
    'why.title': 'Talent <em>is not enough</em>',
    'why.p1':
      'We see more than the footballer in you: we also see the person, the brand and the wealth behind them. With a weekly method and a team of specialists we take you to your maximum — in sport, in life and financially.',
    'why.p2': 'SCM thinks and acts for your future, far beyond the limits of the pitch.',
    'why.p3': 'Join SCM and become the playmaker of your career.',
    'why.cta': 'Official roster on Transfermarkt',
